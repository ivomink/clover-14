...
public sealed partial class NoEorgPopup : FancyWindow
{
    ...
    private void InitializeUI()
    {
        ...
        _initialSkipState =
            _cfg.GetCVar(CloverCCVars.SkipRoundEndNoEorgPopup); // Store the initial CVar value to compare against
    ...
    {
        _remainingTime = _cfg.GetCVar(CloverCCVars.RoundEndNoEorgPopupTime); // Set how long to show the popup for
        UpdateCloseButtonText();
    }
    ...
    private void SaveSkipState()
    {
        ...
        _cfg.SetCVar(CloverCCVars.SkipRoundEndNoEorgPopup, SkipCheckBox.Pressed);
        _cfg.SaveToFile();
    }
